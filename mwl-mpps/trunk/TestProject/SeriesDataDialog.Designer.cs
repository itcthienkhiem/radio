using DrScribe.MWLServer;
using DrScribe.MWLServer.WorkListDBDataSetTableAdapters;
...
namespace Edgeteks.MWLServer
{
    partial class SeriesDataDialog
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.workListDBDataSet = new DrScribe.MWLServer.WorkListDBDataSet();
            this.performedSeriesBindingSource = new System.Windows.Forms.BindingSource(this.components);
            this.performedSeriesTableAdapter = new DrScribe.MWLServer.WorkListDBDataSetTableAdapters.PerformedSeriesTableAdapter();
            ...
            this.referencedImagesTableAdapter = new DrScribe.MWLServer.WorkListDBDataSetTableAdapters.ReferencedImagesTableAdapter();
