...
{
    public partial class frm_QuickRegistration : BaseForm
    {
        ...
        public frm_QuickRegistration(int CurrDevice_ID)
        {
            InitializeComponent();
            ...
            this.KeyDown += new KeyEventHandler(frm_QuickRegistration_KeyDown);
        ...
        void txtPName_LostFocus(object sender, EventArgs e)
        {
            try
            {
                this.AcceptButton = cmdBeginExam;
            }
            catch
            {
            }
        ...
        void frm_QuickRegistration_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private void InitView()
        {
            switch (Act)
            {
                ...
                case action.Update:
                     ...
                     cboPhysician.SelectedIndex = Utility.GetSelectedIndex(cboPhysician, Utility.sDbnull(dr["PHYSICIAN"]));
        ...
        {
            return txtID.Text.Trim() + "_" + Bodau(txtPName.Text.Trim()).Replace(txtAge.Text.Trim(), "").Trim().Replace(" ", "_").Trim() + "_" + txtAge.Text;
        }
        ...
        private void frm_QuickRegistration_Load(object sender, EventArgs e)
        {
