...
namespace DicomDemo
{
   ...
   public class MainForm : System.Windows.Forms.Form
   {
      ...
      private Leadtools.WinForms.RasterImageList ImageList;
      ...
      private void InitializeComponent( )
      {
          ...
          this.ImageList.Size = new System.Drawing.Size(136, 248);
...
#if LTV17_CONFIG
         RegistryKey settings = user.OpenSubKey(@"SOFTWARE\LEAD Technologies, Inc.\17\CSharp_DicomFindMove17", true);
#elif LTV16_CONFIG
         RegistryKey settings = user.OpenSubKey(@"SOFTWARE\LEAD Technologies, Inc.\16\CSharp_DicomFindMove16", true);
#else
         RegistryKey settings = user.OpenSubKey(@"SOFTWARE\LEAD Technologies, Inc.\15\CSharp_DicomFindMove15", true);
#endif
         if (settings == null)
         {
            //
      ...
      private void SaveSettings( )
      {
         ...
         {
#if LTV17_CONFIG
            settings = user.CreateSubKey(@"SOFTWARE\LEAD Technologies, Inc.\17\CSharp_DicomFindMove17");
#elif LTV16_CONFIG
            settings = user.CreateSubKey(@"SOFTWARE\LEAD Technologies, Inc.\16\CSharp_DicomFindMove16");
#else
            settings = user.CreateSubKey(@"SOFTWARE\LEAD Technologies, Inc.\15\CSharp_DicomFindMove15");
#endif
         }
      ...
      private void listViewSeries_DoubleClick(object sender, System.EventArgs e)
      {
         ...
         DicomDataSet ds = listViewSeries.SelectedItems[0].Tag as DicomDataSet;
         DicomDataSet dsStudy = listViewStudies.SelectedItems[0].Tag as DicomDataSet;

         patientID = Utils.GetStringValue(dsStudy, DemoDicomTags.PatientID);
