...
{
    /// <summary>
    /// Strongly-typed collection for the ArchiveQueueStatusEnum class.
    /// </summary>
    [Serializable]
    public class ArchiveQueueStatusEnumCollection : ActiveList<ArchiveQueueStatusEnum, ArchiveQueueStatusEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ArchiveQueueStatusEnumCollection</returns>
        public ArchiveQueueStatusEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                ArchiveQueueStatusEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the ArchiveQueueStatusEnum table.
    /// </summary>
    [Serializable]
    public class ArchiveQueueStatusEnum : ActiveRecord<ArchiveQueueStatusEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public ArchiveQueueStatusEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public ArchiveQueueStatusEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ArchiveQueueStatusEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public ArchiveQueueStatusEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("ArchiveQueueStatusEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("ArchiveQueueStatusEnum", schema);
            }
        }
        ...
        {
            return new ArchiveQueueCollection().Where(ArchiveQueue.Columns.ArchiveQueueStatusEnum, EnumX).Load();
        }
