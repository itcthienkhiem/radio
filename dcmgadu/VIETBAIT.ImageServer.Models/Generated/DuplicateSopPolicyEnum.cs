...
{
    /// <summary>
    /// Strongly-typed collection for the DuplicateSopPolicyEnum class.
    /// </summary>
    [Serializable]
    public class DuplicateSopPolicyEnumCollection : ActiveList<DuplicateSopPolicyEnum, DuplicateSopPolicyEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DuplicateSopPolicyEnumCollection</returns>
        public DuplicateSopPolicyEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                DuplicateSopPolicyEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the DuplicateSopPolicyEnum table.
    /// </summary>
    [Serializable]
    public class DuplicateSopPolicyEnum : ActiveRecord<DuplicateSopPolicyEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public DuplicateSopPolicyEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public DuplicateSopPolicyEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public DuplicateSopPolicyEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public DuplicateSopPolicyEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("DuplicateSopPolicyEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("DuplicateSopPolicyEnum", schema);
            }
        }
        ...
        public ServerPartitionCollection ServerPartitionRecords()
        {
            return new ServerPartitionCollection().Where(ServerPartition.Columns.DuplicateSopPolicyEnum, EnumX).Load();
        }
