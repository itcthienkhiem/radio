...
{
    /// <summary>
    /// Strongly-typed collection for the ServerRuleApplyTimeEnum class.
    /// </summary>
    [Serializable]
    public class ServerRuleApplyTimeEnumCollection :
        ActiveList<ServerRuleApplyTimeEnum, ServerRuleApplyTimeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ServerRuleApplyTimeEnumCollection</returns>
        public ServerRuleApplyTimeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                ServerRuleApplyTimeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the ServerRuleApplyTimeEnum table.
    /// </summary>
    [Serializable]
    public class ServerRuleApplyTimeEnum : ActiveRecord<ServerRuleApplyTimeEnum>, IActiveRecord
    {
        ...
        public ServerRuleApplyTimeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ServerRuleApplyTimeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public ServerRuleApplyTimeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("ServerRuleApplyTimeEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("ServerRuleApplyTimeEnum", schema);
            }
        }
        ...
        {
            return new ServerRuleCollection().Where(ServerRule.Columns.ServerRuleApplyTimeEnum, EnumX).Load();
        }
