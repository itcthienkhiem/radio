...
{
    /// <summary>
    /// Strongly-typed collection for the ArchiveTypeEnum class.
    /// </summary>
    [Serializable]
    public class ArchiveTypeEnumCollection : ActiveList<ArchiveTypeEnum, ArchiveTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ArchiveTypeEnumCollection</returns>
        public ArchiveTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                ArchiveTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the ArchiveTypeEnum table.
    /// </summary>
    [Serializable]
    public class ArchiveTypeEnum : ActiveRecord<ArchiveTypeEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public ArchiveTypeEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public ArchiveTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ArchiveTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public ArchiveTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("ArchiveTypeEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("ArchiveTypeEnum", schema);
            }
        }
        ...
        {
            return new PartitionArchiveCollection().Where(PartitionArchive.Columns.ArchiveTypeEnum, EnumX).Load();
        }
