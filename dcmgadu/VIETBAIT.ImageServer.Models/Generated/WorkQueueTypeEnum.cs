...
{
    /// <summary>
    /// Strongly-typed collection for the WorkQueueTypeEnum class.
    /// </summary>
    [Serializable]
    public class WorkQueueTypeEnumCollection : ActiveList<WorkQueueTypeEnum, WorkQueueTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>WorkQueueTypeEnumCollection</returns>
        public WorkQueueTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                WorkQueueTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the WorkQueueTypeEnum table.
    /// </summary>
    [Serializable]
    public class WorkQueueTypeEnum : ActiveRecord<WorkQueueTypeEnum>, IActiveRecord
    {
        ...
        public WorkQueueTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WorkQueueTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WorkQueueTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("WorkQueueTypeEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("WorkQueueTypeEnum", schema);
            }
        }
        ...
        {
            return new WorkQueueCollection().Where(WorkQueue.Columns.WorkQueueTypeEnum, EnumX).Load();
        }

        public WorkQueueTypePropertyCollection WorkQueueTypeProperties()
        {
            return
                new WorkQueueTypePropertyCollection().Where(WorkQueueTypeProperty.Columns.WorkQueueTypeEnum, EnumX).Load
                    ();
        }
