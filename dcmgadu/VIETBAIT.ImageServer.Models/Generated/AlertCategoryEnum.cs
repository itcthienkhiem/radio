...
{
    /// <summary>
    /// Strongly-typed collection for the AlertCategoryEnum class.
    /// </summary>
    [Serializable]
    public class AlertCategoryEnumCollection : ActiveList<AlertCategoryEnum, AlertCategoryEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AlertCategoryEnumCollection</returns>
        public AlertCategoryEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                AlertCategoryEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the AlertCategoryEnum table.
    /// </summary>
    [Serializable]
    public class AlertCategoryEnum : ActiveRecord<AlertCategoryEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public AlertCategoryEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public AlertCategoryEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public AlertCategoryEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public AlertCategoryEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("AlertCategoryEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("AlertCategoryEnum", schema);
            }
        }
        ...
        public AlertCollection AlertRecords()
        {
            return new AlertCollection().Where(Alert.Columns.AlertCategoryEnum, EnumX).Load();
        }
