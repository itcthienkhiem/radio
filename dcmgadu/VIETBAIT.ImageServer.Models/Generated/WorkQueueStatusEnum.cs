...
{
    /// <summary>
    /// Strongly-typed collection for the WorkQueueStatusEnum class.
    /// </summary>
    [Serializable]
    public class WorkQueueStatusEnumCollection : ActiveList<WorkQueueStatusEnum, WorkQueueStatusEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>WorkQueueStatusEnumCollection</returns>
        public WorkQueueStatusEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                WorkQueueStatusEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the WorkQueueStatusEnum table.
    /// </summary>
    [Serializable]
    public class WorkQueueStatusEnum : ActiveRecord<WorkQueueStatusEnum>, IActiveRecord
    {
        ...
        public WorkQueueStatusEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WorkQueueStatusEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WorkQueueStatusEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("WorkQueueStatusEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("WorkQueueStatusEnum", schema);
            }
        }
        ...
        {
            return new WorkQueueCollection().Where(WorkQueue.Columns.WorkQueueStatusEnum, EnumX).Load();
        }
