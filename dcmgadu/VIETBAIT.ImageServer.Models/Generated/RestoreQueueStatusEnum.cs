...
{
    /// <summary>
    /// Strongly-typed collection for the RestoreQueueStatusEnum class.
    /// </summary>
    [Serializable]
    public class RestoreQueueStatusEnumCollection : ActiveList<RestoreQueueStatusEnum, RestoreQueueStatusEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>RestoreQueueStatusEnumCollection</returns>
        public RestoreQueueStatusEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                RestoreQueueStatusEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the RestoreQueueStatusEnum table.
    /// </summary>
    [Serializable]
    public class RestoreQueueStatusEnum : ActiveRecord<RestoreQueueStatusEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public RestoreQueueStatusEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public RestoreQueueStatusEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public RestoreQueueStatusEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public RestoreQueueStatusEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("RestoreQueueStatusEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("RestoreQueueStatusEnum", schema);
            }
        }
        ...
        {
            return new RestoreQueueCollection().Where(RestoreQueue.Columns.RestoreQueueStatusEnum, EnumX).Load();
        }
