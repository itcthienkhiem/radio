...
{
    /// <summary>
    /// Strongly-typed collection for the AlertLevelEnum class.
    /// </summary>
    [Serializable]
    public class AlertLevelEnumCollection : ActiveList<AlertLevelEnum, AlertLevelEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>AlertLevelEnumCollection</returns>
        public AlertLevelEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                AlertLevelEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the AlertLevelEnum table.
    /// </summary>
    [Serializable]
    public class AlertLevelEnum : ActiveRecord<AlertLevelEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public AlertLevelEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public AlertLevelEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public AlertLevelEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public AlertLevelEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("AlertLevelEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("AlertLevelEnum", schema);
            }
        }
        ...
        {
            return new AlertCollection().Where(Alert.Columns.AlertLevelEnum, EnumX).Load();
        }
