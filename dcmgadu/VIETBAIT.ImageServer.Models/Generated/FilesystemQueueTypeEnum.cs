...
{
    /// <summary>
    /// Strongly-typed collection for the FilesystemQueueTypeEnum class.
    /// </summary>
    [Serializable]
    public class FilesystemQueueTypeEnumCollection :
        ActiveList<FilesystemQueueTypeEnum, FilesystemQueueTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>FilesystemQueueTypeEnumCollection</returns>
        public FilesystemQueueTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                FilesystemQueueTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the FilesystemQueueTypeEnum table.
    /// </summary>
    [Serializable]
    public class FilesystemQueueTypeEnum : ActiveRecord<FilesystemQueueTypeEnum>, IActiveRecord
    {
        ...
        public FilesystemQueueTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public FilesystemQueueTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public FilesystemQueueTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("FilesystemQueueTypeEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("FilesystemQueueTypeEnum", schema);
            }
        }
        ...
        {
            return new FilesystemQueueCollection().Where(FilesystemQueue.Columns.FilesystemQueueTypeEnum, EnumX).Load();
        }
