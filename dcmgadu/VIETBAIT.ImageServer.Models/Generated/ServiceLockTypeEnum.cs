...
{
    /// <summary>
    /// Strongly-typed collection for the ServiceLockTypeEnum class.
    /// </summary>
    [Serializable]
    public class ServiceLockTypeEnumCollection : ActiveList<ServiceLockTypeEnum, ServiceLockTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ServiceLockTypeEnumCollection</returns>
        public ServiceLockTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                ServiceLockTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the ServiceLockTypeEnum table.
    /// </summary>
    [Serializable]
    public class ServiceLockTypeEnum : ActiveRecord<ServiceLockTypeEnum>, IActiveRecord
    {
        ...
        public ServiceLockTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ServiceLockTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public ServiceLockTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("ServiceLockTypeEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("ServiceLockTypeEnum", schema);
            }
        }
        ...
        {
            return new ServiceLockCollection().Where(ServiceLock.Columns.ServiceLockTypeEnum, EnumX).Load();
        }
