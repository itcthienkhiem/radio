...
{
    /// <summary>
    /// Strongly-typed collection for the DeviceTypeEnum class.
    /// </summary>
    [Serializable]
    public class DeviceTypeEnumCollection : ActiveList<DeviceTypeEnum, DeviceTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>DeviceTypeEnumCollection</returns>
        public DeviceTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                DeviceTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the DeviceTypeEnum table.
    /// </summary>
    [Serializable]
    public class DeviceTypeEnum : ActiveRecord<DeviceTypeEnum>, IActiveRecord
    {
        ...
        public DeviceTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public DeviceTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public DeviceTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("DeviceTypeEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("DeviceTypeEnum", schema);
            }
        }
        ...
        {
            return new DeviceCollection().Where(Device.Columns.DeviceTypeEnum, EnumX).Load();
        }
