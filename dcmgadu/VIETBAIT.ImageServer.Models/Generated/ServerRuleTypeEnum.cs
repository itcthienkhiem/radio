...
{
    /// <summary>
    /// Strongly-typed collection for the ServerRuleTypeEnum class.
    /// </summary>
    [Serializable]
    public class ServerRuleTypeEnumCollection : ActiveList<ServerRuleTypeEnum, ServerRuleTypeEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>ServerRuleTypeEnumCollection</returns>
        public ServerRuleTypeEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                ServerRuleTypeEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the ServerRuleTypeEnum table.
    /// </summary>
    [Serializable]
    public class ServerRuleTypeEnum : ActiveRecord<ServerRuleTypeEnum>, IActiveRecord
    {
        ...
        public ServerRuleTypeEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public ServerRuleTypeEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public ServerRuleTypeEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("ServerRuleTypeEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("ServerRuleTypeEnum", schema);
            }
        }
        ...
        {
            return new ServerRuleCollection().Where(ServerRule.Columns.ServerRuleTypeEnum, EnumX).Load();
        }
