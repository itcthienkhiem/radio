...
{
    /// <summary>
    /// Strongly-typed collection for the QueueStudyStateEnum class.
    /// </summary>
    [Serializable]
    public class QueueStudyStateEnumCollection : ActiveList<QueueStudyStateEnum, QueueStudyStateEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>QueueStudyStateEnumCollection</returns>
        public QueueStudyStateEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                QueueStudyStateEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the QueueStudyStateEnum table.
    /// </summary>
    [Serializable]
    public class QueueStudyStateEnum : ActiveRecord<QueueStudyStateEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public QueueStudyStateEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public QueueStudyStateEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public QueueStudyStateEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public QueueStudyStateEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("QueueStudyStateEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("QueueStudyStateEnum", schema);
            }
        }
        ...
        {
            return new StudyStorageCollection().Where(StudyStorage.Columns.QueueStudyStateEnum, EnumX).Load();
        }
