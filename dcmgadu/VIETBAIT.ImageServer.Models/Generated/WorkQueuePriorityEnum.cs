...
{
    /// <summary>
    /// Strongly-typed collection for the WorkQueuePriorityEnum class.
    /// </summary>
    [Serializable]
    public class WorkQueuePriorityEnumCollection : ActiveList<WorkQueuePriorityEnum, WorkQueuePriorityEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>WorkQueuePriorityEnumCollection</returns>
        public WorkQueuePriorityEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                WorkQueuePriorityEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the WorkQueuePriorityEnum table.
    /// </summary>
    [Serializable]
    public class WorkQueuePriorityEnum : ActiveRecord<WorkQueuePriorityEnum>, IActiveRecord
    {
        #region .ctors and Default Settings

        public WorkQueuePriorityEnum()
        {
            SetSQLProps();
            InitSetDefaults();
            MarkNew();
        ...
        public WorkQueuePriorityEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public WorkQueuePriorityEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public WorkQueuePriorityEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("WorkQueuePriorityEnum", TableType.Table,
                ...
                DataService.Providers["ORM"].AddSchema("WorkQueuePriorityEnum", schema);
            }
        }
        ...
        {
            return new WorkQueueCollection().Where(WorkQueue.Columns.WorkQueuePriorityEnum, EnumX).Load();
        }

        public WorkQueueTypePropertyCollection WorkQueueTypeProperties()
        {
            return
                new WorkQueueTypePropertyCollection().Where(WorkQueueTypeProperty.Columns.WorkQueuePriorityEnum, EnumX).
                    Load();
        }
