...
{
    /// <summary>
    /// Strongly-typed collection for the StudyStatusEnum class.
    /// </summary>
    [Serializable]
    public class StudyStatusEnumCollection : ActiveList<StudyStatusEnum, StudyStatusEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>StudyStatusEnumCollection</returns>
        public StudyStatusEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                StudyStatusEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the StudyStatusEnum table.
    /// </summary>
    [Serializable]
    public class StudyStatusEnum : ActiveRecord<StudyStatusEnum>, IActiveRecord
    {
        ...
        public StudyStatusEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public StudyStatusEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public StudyStatusEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("StudyStatusEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("StudyStatusEnum", schema);
            }
        }
        ...
        {
            return new StudyStorageCollection().Where(StudyStorage.Columns.StudyStatusEnum, EnumX).Load();
        }
