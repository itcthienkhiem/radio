...
{
    /// <summary>
    /// Strongly-typed collection for the FilesystemTierEnum class.
    /// </summary>
    [Serializable]
    public class FilesystemTierEnumCollection : ActiveList<FilesystemTierEnum, FilesystemTierEnumCollection>
    {
        /// <summary>
        /// Filters an existing collection based on the set criteria. This is an in-memory filter
        /// Thanks to developingchris for this!
        /// </summary>
        /// <returns>FilesystemTierEnumCollection</returns>
        public FilesystemTierEnumCollection Filter()
        {
            for (int i = Count - 1; i > -1; i--)
            {
                FilesystemTierEnum o = this[i];
    ...
    /// <summary>
    /// This is an ActiveRecord class which wraps the FilesystemTierEnum table.
    /// </summary>
    [Serializable]
    public class FilesystemTierEnum : ActiveRecord<FilesystemTierEnum>, IActiveRecord
    {
        ...
        public FilesystemTierEnum(bool useDatabaseDefaults)
        {
            SetSQLProps();
        ...
        public FilesystemTierEnum(object keyID)
        {
            SetSQLProps();
            InitSetDefaults();
            LoadByKey(keyID);
        ...
        public FilesystemTierEnum(string columnName, object columnValue)
        {
            SetSQLProps();
            InitSetDefaults();
        ...
        private static void GetTableSchema()
        {
            ...
            {
                //Schema declaration
                var schema = new TableSchema.Table("FilesystemTierEnum", TableType.Table, DataService.GetInstance("ORM"));
                ...
                DataService.Providers["ORM"].AddSchema("FilesystemTierEnum", schema);
            }
        }
        ...
        public FilesystemCollection FilesystemRecords()
        {
            return new FilesystemCollection().Where(Filesystem.Columns.FilesystemTierEnum, EnumX).Load();
        }
        ...
        {
            var item = new FilesystemTierEnum();
