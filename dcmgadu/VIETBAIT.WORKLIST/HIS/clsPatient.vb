...
Namespace HIS
    Public Class clsPatient
        ...
        Sub CreateMessage(ByVal cfcmd As CFIND, ByVal ParsedPDU As PDataTFPDU, ByVal stream As NetworkStream, _
                           ByVal sPID As String, ByVal sPatientName As String)
            ...
            If Me.spGetPatientInfo(sPID, sPatientName, DateNow2, DateNow2, 1, dt) Then
                For iCount = 0 To dt.Rows.Count - 1
                    ...
                    cfmessagedata = cfcmd.CreateCFRSPData(ParsedPDU.PDVContent, sPID, sPatientName, sPID, pSex, _
                                               DateNow, TimeNow, "VIETBAIT", True, dt.Rows(iCount).Item("YEAR_BIRTH").ToString, "CT")
