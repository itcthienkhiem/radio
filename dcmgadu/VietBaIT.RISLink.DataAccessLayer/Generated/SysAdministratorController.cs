...
namespace VietBaIT.RISLink.DataAccessLayer
{
    ...
    public partial class SysAdministratorController
    {
	    ...
	    public void Insert(string PkSAdminID,string FpSBranchID,string PkSCreator,string SPWD,int? IMonth,int? IYear)
	    {
	    ...
	    public void Update(string PkSAdminID,string FpSBranchID,string PkSCreator,string SPWD,int? IMonth,int? IYear)
	    {
		    SysAdministrator item = new SysAdministrator();
	        item.MarkOld();
	        item.IsLoaded = true;
