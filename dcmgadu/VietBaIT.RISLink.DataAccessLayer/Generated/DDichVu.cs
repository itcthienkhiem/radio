...
namespace VietBaIT.RISLink.DataAccessLayer
{
	...
	public partial class DDichVu : ActiveRecord<DDichVu>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(int varIdLoaiDvu,string varMaDvu,string varTenDvu,string varTenDvuEn,int? varSttHthi,int varTrangThai,int varIdVungKs,string varMoTa)
		{
		...
		/// </summary>
		public static void Update(int varIdDvu,int varIdLoaiDvu,string varMaDvu,string varTenDvu,string varTenDvuEn,int? varSttHthi,int varTrangThai,int varIdVungKs,string varMoTa)
		{
			DDichVu item = new DDichVu();
