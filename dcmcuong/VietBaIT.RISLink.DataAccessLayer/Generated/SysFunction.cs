...
namespace VietBaIT.RISLink.DataAccessLayer
{
	...
	public partial class SysFunction : ActiveRecord<SysFunction>, IActiveRecord
	{
		...
		/// </summary>
		public static void Insert(string varFpSBranchID,string varSFunctionName,string varSDLLname,string varSFormName,string varSAssemblyName,bool? varBEnable,string varSParameterList,string varSDesc)
		{
		...
		/// </summary>
		public static void Update(long varPkIid,string varFpSBranchID,string varSFunctionName,string varSDLLname,string varSFormName,string varSAssemblyName,bool? varBEnable,string varSParameterList,string varSDesc)
		{
			SysFunction item = new SysFunction();
