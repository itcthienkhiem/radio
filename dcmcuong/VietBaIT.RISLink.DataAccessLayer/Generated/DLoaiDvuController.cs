...
namespace VietBaIT.RISLink.DataAccessLayer
{
    ...
    public partial class DLoaiDvuController
    {
	    ...
	    public void Insert(string MaLoaiDvu,string TenLoaiDvu,string TenLoaiDvuEn,int? SttHthi,int TrangThai,string CustomField1,string CustomField2,string CustomField3)
	    {
	    ...
	    public void Update(int IdLoaiDvu,string MaLoaiDvu,string TenLoaiDvu,string TenLoaiDvuEn,int? SttHthi,int TrangThai,string CustomField1,string CustomField2,string CustomField3)
	    {
		    DLoaiDvu item = new DLoaiDvu();
	        item.MarkOld();
	        item.IsLoaded = true;
