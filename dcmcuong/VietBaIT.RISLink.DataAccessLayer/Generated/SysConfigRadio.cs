	...
	public partial class SysConfigRadio : ActiveRecord<SysConfigRadio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarSysId.DataType = DbType.AnsiString;
				colvarSysId.MaxLength = 50;
				colvarSysId.AutoIncrement = false;
				...
				TableSchema.TableColumn colvarIsSave = new TableSchema.TableColumn(schema);
				colvarIsSave.ColumnName = "IsSave";
				colvarIsSave.DataType = DbType.Int32;
				colvarIsSave.MaxLength = 0;
				colvarIsSave.AutoIncrement = false;
				colvarIsSave.IsNullable = true;
				colvarIsSave.IsPrimaryKey = false;
				colvarIsSave.IsForeignKey = false;
				colvarIsSave.IsReadOnly = false;
				colvarIsSave.DefaultSetting = @"";
				colvarIsSave.ForeignKeyTableName = "";
				schema.Columns.Add(colvarIsSave);
		...
		public string SysId 
		{
			get { return GetColumnValue<string>(Columns.SysId); }
		...
		public int? IsSave 
		{
			get { return GetColumnValue<int?>(Columns.IsSave); }
			set { SetColumnValue(Columns.IsSave, value); }
		}
		...
		/// </summary>
		public static void Insert(string varSysId,string varUserName,string varPassWord,string varDomain,string varPathUNC,int? varIsSave)
		{
		...
		/// </summary>
		public static void Update(string varSysId,string varUserName,string varPassWord,string varDomain,string varPathUNC,int? varIsSave)
		{
			SysConfigRadio item = new SysConfigRadio();
        ...
        public static TableSchema.TableColumn IsSaveColumn
        {
