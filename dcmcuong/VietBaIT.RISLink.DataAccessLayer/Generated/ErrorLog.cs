	...
	public partial class ErrorLog : ActiveRecord<ErrorLog>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			if(!IsSchemaInitialized)
			{
				...
				colvarApplicationName.MaxLength = 500;
				...
				TableSchema.TableColumn colvarErrorCode = new TableSchema.TableColumn(schema);
				colvarErrorCode.ColumnName = "Error_Code";
				colvarErrorCode.DataType = DbType.String;
				colvarErrorCode.MaxLength = 50;
				colvarErrorCode.AutoIncrement = false;
				colvarErrorCode.IsNullable = true;
				colvarErrorCode.IsPrimaryKey = false;
				colvarErrorCode.IsForeignKey = false;
				colvarErrorCode.IsReadOnly = false;
				colvarErrorCode.DefaultSetting = @"";
				colvarErrorCode.ForeignKeyTableName = "";
				schema.Columns.Add(colvarErrorCode);
		...
		{
			get { return GetColumnValue<string>(Columns.ErrorCode); }
			set { SetColumnValue(Columns.ErrorCode, value); }
		}
		...
		/// </summary>
		public static void Insert(string varUserName,string varFormName,DateTime? varErrorTime,string varApplicationName,string varErrorContent,string varErrorCode)
		{
		...
		/// </summary>
		public static void Update(int varErrorId,string varUserName,string varFormName,DateTime? varErrorTime,string varApplicationName,string varErrorContent,string varErrorCode)
		{
			ErrorLog item = new ErrorLog();
        ...
        public static TableSchema.TableColumn ErrorCodeColumn
        {
