...
Namespace WorkList
    Public Class FileMetaFormat
        ...
        Function CreateFile(ByVal ImageDataElements As List(Of DataElement), ByVal path As String) As ArrayList
            ...
            AddDataSet(CStr(sop.ImplicitLittleEndian), CUInt(FMITransferSyntaxTag))
            Dim len As UInt32 = 0
        ...
        Function ReadDCMFile(ByVal path As String) As List(Of DataElement)
            ...
            Dim DataElements As New List(Of DataElement)
